...
- [ ] **PSET-07**: 4개 Preset × 2개 인프라(Local/AWS)를 파라메트릭하게 순회하는 cross-preset regression matrix 테스트
...
| FUND-01 | Phase 2 | Pending |
| FUND-02 | Phase 2 | Pending |
...
| DTGT-01 | Phase 3 | Pending |
| DTGT-02 | Phase 3 | Pending |
| DTGT-03 | Phase 3 | Pending |
| DTGT-04 | Phase 3 | Pending |
